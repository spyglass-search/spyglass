...
export function IndexWebHelp() {
  return (
    ...
    <div className="text-sm">
        Add lenses from the <span className="font-bold text-cyan-500">{"Discover"}</span>
        {" tab to begin searching your favorite web content instantly."}
    </div>
    <div>
        <img src={discoverTab} className="w-[300px] mx-auto rounded shadow-md shadow-cyan-500/50"/>
    </div>
  </div>
  );
}
