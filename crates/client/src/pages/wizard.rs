        ...
        <div class="p-4">
            ...
            <div class="text-sm">
                ...
                <div class="grid grid-cols-3 gap-2 text-sm">
                    <a href="" class="text-center bg-neutral-900 rounded-lg border-neutral-700 p-4 hover:bg-amber-700">
                        <icons::StarIcon height="h-8" width="w-8" classes="mx-auto mb-2" />
                        <div>{"Star on GitHub"}</div>
                    </a>
                    <a href="" class="block text-center bg-neutral-900 rounded-lg p-4 hover:bg-indigo-900">
                        <img src="discord-logo.png" class="h-8 mx-auto mb-2"/>
                        <div>{"Join our Discord"}</div>
                    </a>
                    <a href="" class="text-center bg-neutral-900 rounded-lg border-neutral-700 p-4 hover:bg-green-900">
